...
class PointLightComponent(var constant: Float = 1f, var linear: Float = 0.09f, var quadratic: Float = 0.032f, intensity: Float = 10.0f, color: Color = Color(1.0f)): LightComponent(intensity, color) {
